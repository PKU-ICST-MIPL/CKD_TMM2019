...
from . import inputs as input_ops
...
class ShowAndTellModel(object):
	...
	def __init__(self, config, mode, train_inception=False, reuse_img_embed=False):
		"""Basic setup.
	...
	def build_image_embeddings(self):
		...
		"""
		inception_output, inception_net = image_embedding.inception_v3(
				self.images,
				trainable=self.train_inception,
				is_training=self.is_training(),
				reuse_inception=self.reuse_img_embed)
